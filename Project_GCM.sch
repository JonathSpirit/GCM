...
U 1 1 5B465FE1
P 700 5250
F 0 "C1" H 725 5350 50  0000 L CNN
F 1 "10nF" H 725 5150 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 738 5100 50  0001 C CNN
...
U 1 1 5B465FE8
P 1150 5750
F 0 "#PWR09" H 1150 5500 50  0001 C CNN
...
U 1 1 5B465FEE
P 1150 4750
F 0 "#PWR010" H 1150 4600 50  0001 C CNN
...
F2 "MEM_ADD_[0..23]" I L 4850 4050 60 
F3 "MEM_~OE" I L 4850 4200 60 
F4 "MEM_~CE" I L 4850 4300 60 
F5 "MEM_~WE" I L 4850 4400 60 
F6 "MEMDATA_[0..7]" B R 6950 4050 60 
$EndSheet
$Sheet
...
F3 "~RESET_CLK" I L 4850 2800 60 
F4 "MEM2DATA_[0..7]" B R 6950 2400 60 
F5 "MEM1DATA_[0..7]" B R 6950 2300 60 
F6 "BREAD1_[0..7]" T L 4850 2300 60 
F7 "BJMPSRC_[0..23]" I L 4850 2550 60 
F8 "SRCADD_[0..23]" I L 4850 2650 60 
F9 "MEM2ADD_[0..23]" O R 6950 2650 60 
F10 "MEM1ADD_[0..23]" O R 6950 2550 60 
F11 "MEM1_~WE" O R 6950 2800 60 
F12 "MEM1_~CE" O R 6950 2900 60 
F13 "MEM1_~OE" O R 6950 3000 60 
F14 "MEM2_~WE" O R 6950 3100 60 
F15 "MEM2_~CE" O R 6950 3200 60 
F16 "MEM2_~OE" O R 6950 3300 60 
F17 "BDATASRC_[0..7]" O R 6950 3450 60 
F18 "SRC_SWITCH_SIGNAL" O R 6950 3600 60 
F19 "~CS~_READ_MODE" I L 4850 2950 60 
F20 "~CS~_WRITE_MODE" I L 4850 3050 60 
F21 "SRCSET_CLK" I L 4850 3200 60 
F22 "MEMWRITE_CLK" I L 4850 3300 60 
$EndSheet
...
U 1 1 5B9F633E
P 3050 5350
F 0 "#PWR012" H 3050 5100 50  0001 C CNN
...
U 1 1 5BB2F491
P 3600 6300
F 0 "#PWR019" H 3600 6050 50  0001 C CNN
...
U 1 1 5D028BEC
P 5350 5700
F 0 "#PWR0107" H 5350 5550 50  0001 C CNN
F 1 "+5V" H 5350 5840 50  0000 C CNN
...
F2 "MEM_ADD_[0..23]" I L 4850 4850 60 
F3 "MEM_~OE" I L 4850 5000 60 
F4 "MEM_~CE" I L 4850 5100 60 
F5 "MEM_~WE" I L 4850 5200 60 
F6 "MEMDATA_[0..7]" B R 6950 4850 60 
$EndSheet
Wire Bus Line
	4800 4850 4850 4850
Wire Wire Line
...
U 1 1 5F741CC0
P 1150 5250
F 0 "U1" H 1350 5700 50  0000 R CNN
F 1 "LM810" H 1450 5600 50  0000 R CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 1450 5350 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/lm809.pdf" H 1450 5350 50  0001 C CNN
	1    1150 5250
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F7D4A02
P 3600 6000
F 0 "U5" H 3700 6250 50  0000 L CNN
F 1 "74AHC1G04" H 3700 6150 50  0000 L CNN
F 2 "" H 3600 6000 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74AHC_AHCT1G04.pdf" H 3600 6000 50  0001 C CNN
	1    3600 6000
	1    0    0    -1  
$EndComp
...
U 1 1 5F814151
P 5350 6000
F 0 "U11" H 5450 6250 50  0000 L CNN
F 1 "74AHC1G04" H 5450 6150 50  0000 L CNN
F 2 "" H 5350 6000 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74AHC_AHCT1G04.pdf" H 5350 6000 50  0001 C CNN
	1    5350 6000
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F8A959B
P 3050 5050
F 0 "U3" H 3150 5300 50  0000 L CNN
F 1 "74AHC1G32" H 3150 5200 50  0000 L CNN
F 2 "" H 3050 5050 50  0001 C CNN
F 3 "http://www.ti.com/lit/sg/scyt129e/scyt129e.pdf" H 3050 5050 50  0001 C CNN
	1    3050 5050
	1    0    0    -1  
$EndComp
Wire Bus Line
